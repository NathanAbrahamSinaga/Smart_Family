...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username) || empty($password)) {
        header("Location: " . BASE_URL . "src/loginPage/loginTarombo.php?login_gagal=lengkapi");
        exit();
    }
    ...
    if (!$stmt) {
        header("Location: " . BASE_URL . "src/loginPage/loginTarombo.php?login_gagal=stmt_prepare");
        exit();
    }
